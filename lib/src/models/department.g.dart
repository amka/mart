...
extension DepartmentQueryFilter
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQuerySortBy
  ...
  QueryBuilder<Department, Department, QAfterSortBy> sortByDisplayName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> sortByDisplayNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQuerySortThenBy
  ...
  QueryBuilder<Department, Department, QAfterSortBy> thenByDisplayName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> thenByDisplayNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.desc);
    });
  }
...
extension DepartmentQueryWhereDistinct
  ...
  QueryBuilder<Department, Department, QDistinct> distinctByDisplayName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQueryProperty
  ...
  QueryBuilder<Department, String, QQueryOperations> displayNameProperty() {
    return QueryBuilder.apply(this, (query) {
